...
#    Updated: 2025/11/10 18:31:23 by shunwata         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = $(addprefix $(SRC_DIR)/, builtin_test.c core_executer.c core_parser.c core_tokenizer.c get_fullpath.c main.c utils_common.c utils_parser.c utils_executer.c)
OBJ = $(SRC:.c=.o)
