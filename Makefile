...
#    Updated: 2025/12/21 20:17:36 by nmasuda          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
MAIN_SRC	= $(addprefix $(SRC_DIR)/, core_executor.c core_expander.c core_parser.c \
				core_tokenizer.c debug.c executor_builtin.c executor_heredoc.c expander_ev.c expander_quote.c\
				get_fullpath.c init.c main.c parser_redir.c put_err.c signal.c split_improved.c \
				utils_common.c utils_executor.c utils_expander.c utils_parser.c utils_tokenizer.c)
